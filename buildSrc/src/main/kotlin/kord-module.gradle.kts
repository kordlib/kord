    ...
    withType<AbstractDokkaLeafTask>().configureEach {
        ...
        dokkaSourceSets.configureEach {
            ...
            sourceLink {
                ...
                remoteUrl = URL("$baseRemoteUrl/src/main/kotlin")
                remoteLineSuffix = "#L"
            }
            ...
            sourceLink {
                ...
                localDirectory = file("build/generated/ksp/main/kotlin").apply { mkdirs() }
                remoteUrl = URL("$baseRemoteUrl/build/generated/ksp/main/kotlin")
                remoteLineSuffix = "#L"
            }
