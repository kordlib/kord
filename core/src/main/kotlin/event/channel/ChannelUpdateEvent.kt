...
class ThreadChannelUpdateEvent(override val channel: ThreadChannel, override val shard: Int) : ChannelUpdateEvent {
    override fun toString(): String {
        return "ThreadChannelUpdateEvent(channel=$channel, shard=$shard)"
    }
}
