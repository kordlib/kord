...
internal class ThreadEventHandler(
    cache: DataCache
    ...
    private suspend fun handle(event: ThreadCreate, shard: Int, kord: Kord, coroutineScope: CoroutineScope): CoreEvent? {
    ...
    private suspend fun handle(event: ThreadUpdate, shard: Int, kord: Kord, coroutineScope: CoroutineScope): CoreEvent? {
        val channelData = event.channel.toData()
    ...
    private suspend fun handle(event: ThreadDelete, shard: Int, kord: Kord, coroutineScope: CoroutineScope): ThreadChannelDeleteEvent {
    ...
    private suspend fun handle(event: ThreadListSync, shard: Int, kord: Kord, coroutineScope: CoroutineScope): ThreadListSyncEvent {
    ...
    private fun handle(event: ThreadMemberUpdate, shard: Int, kord: Kord, coroutineScope: CoroutineScope): ThreadMemberUpdateEvent {
    ...
    private suspend fun handle(event: ThreadMembersUpdate, shard: Int, kord: Kord, coroutineScope: CoroutineScope): ThreadMembersUpdateEvent {
