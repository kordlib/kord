...
public class MessagePollVoteAddEvent(
    ...
    override fun withStrategy(strategy: EntitySupplyStrategy<*>): MessagePollVoteAddEvent = MessagePollVoteAddEvent(
        userId,
        channelId,
        messageId,
        guildId,
    ...
    override fun toString(): String = "MessagePollVoteAddEvent(userId=$userId, channelId=$channelId, " +
