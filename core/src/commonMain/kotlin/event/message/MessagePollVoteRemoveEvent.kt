...
public class MessagePollVoteRemoveEvent(
    ...
    override fun withStrategy(strategy: EntitySupplyStrategy<*>): MessagePollVoteRemoveEvent = MessagePollVoteRemoveEvent(
        userId,
        channelId,
        messageId,
        guildId,
    ...
    override fun toString(): String = "MessagePollVoteRemoveEvent(userId=$userId, channelId=$channelId, " +
            "messageId=$messageId, guildId=$guildId, answerId=$answerId, kord=$kord, shard=$shard, " +
