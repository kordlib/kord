...
public class MessageUpdateEvent(
     ...
     */
    public override val message: MessageBehavior
        get() = MessageBehavior(
            messageId = messageId,
            channelId = channelId,
            kord = kord
     ...
     */
    public override val channel: MessageChannelBehavior get() = MessageChannelBehavior(id = channelId, kord = kord)

    override val guildId: Snowflake? get() = new.guildId.value
