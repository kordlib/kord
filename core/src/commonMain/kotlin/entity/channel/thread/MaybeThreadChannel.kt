...
/**
 * Either a [TextChannelThread] or a [DeletedThreadChannel].
 */
public sealed interface MaybeThreadChannel : Strategizable {
    public val data: ChannelData
    public val kord: Kord
    public override val supplier: EntitySupplier get() = kord.defaultSupplier
     ...
     */
    public suspend fun getParent(): ThreadParentChannel = supplier.getChannelOf(parentId)
