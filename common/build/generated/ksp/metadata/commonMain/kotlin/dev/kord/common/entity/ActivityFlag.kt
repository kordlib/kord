...
public class ActivityFlags(
    ...
    public override fun toString(): String = "ActivityFlags(values=$values)"

    public class Builder(
        private var code: Int = 0,
    ) {
        public operator fun ActivityFlag.unaryPlus(): Unit {
            this@Builder.code = this@Builder.code or this.code
        }

        public operator fun ActivityFlags.unaryPlus(): Unit {
            this@Builder.code = this@Builder.code or this.code
        }

        public operator fun ActivityFlag.unaryMinus(): Unit {
            this@Builder.code = this@Builder.code and this.code.inv()
        }

        public operator fun ActivityFlags.unaryMinus(): Unit {
            this@Builder.code = this@Builder.code and this.code.inv()
        }
    ...
    internal object Serializer : KSerializer<ActivityFlags> {
        ...
        public override fun serialize(encoder: Encoder, `value`: ActivityFlags) =
