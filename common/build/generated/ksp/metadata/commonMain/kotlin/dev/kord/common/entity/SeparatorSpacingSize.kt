 ...
 *
 *
 * See [SeparatorSpacingSize]s in the [Discord Developer Documentation](https://discord.com/developers/docs/components/reference#separator-separator-structure).
 */
...
public sealed class SeparatorSpacingSize(
    ...
    final override fun equals(other: Any?): Boolean = this === other || (other is SeparatorSpacingSize && this.value == other.value)

    final override fun hashCode(): Int = value.hashCode()

    final override fun toString(): String = if (this is Unknown) "SeparatorSpacingSize.Unknown(value=$value)" else "SeparatorSpacingSize.${this::class.simpleName}"
    ...
    internal object Serializer : KSerializer<SeparatorSpacingSize> {
        override val descriptor: SerialDescriptor =
                PrimitiveSerialDescriptor("dev.kord.common.entity.SeparatorSpacingSize", PrimitiveKind.INT)
    ...
    public companion object {
        ...
        /**
         * Returns an instance of [SeparatorSpacingSize] with [SeparatorSpacingSize.value] equal to the specified [value].
         */
