 ...
 * The type of action.
 *
 * See [AutoModerationActionType]s in the [Discord Developer Documentation](https://discord.com/developers/docs/resources/auto-moderation#auto-moderation-action-object-action-types).
 */
...
public sealed class AutoModerationActionType(
    ...
    final override fun equals(other: Any?): Boolean = this === other || (other is AutoModerationActionType && this.value == other.value)

    final override fun hashCode(): Int = value.hashCode()

    final override fun toString(): String = if (this is Unknown) "AutoModerationActionType.Unknown(value=$value)" else "AutoModerationActionType.${this::class.simpleName}"

    /**
     * An unknown [AutoModerationActionType].
     *
     * This is used as a fallback for [AutoModerationActionType]s that haven't been added to Kord yet.
     */
    ...
    internal object Serializer : KSerializer<AutoModerationActionType> {
        ...
        override fun deserialize(decoder: Decoder): AutoModerationActionType = from(decoder.decodeInt())
    }
