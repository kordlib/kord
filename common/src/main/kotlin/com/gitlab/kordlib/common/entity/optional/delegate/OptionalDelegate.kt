...
fun <V : Any> KMutableProperty0<Optional<V>>.delegate(): ReadWriteProperty<Any?, V?> = object : ReadWriteProperty<Any?, V?> {
...
fun <V : Any> KMutableProperty0<Optional<List<V>>>.delegateList(): ReadWriteProperty<Any?, List<V>> = object : ReadWriteProperty<Any?, List<V>> {
